package tech.inovasoft.inevolving.ms.books.config.log;
...
import tech.inovasoft.inevolving.ms.books.domain.exception.EmailServiceException;
import tech.inovasoft.inevolving.ms.books.service.client.email_service.EmailServiceClient;
import tech.inovasoft.inevolving.ms.books.service.client.email_service.dto.EmailRequest;
    ...
    public void enviarLogSemanal() {
        ...
        if (logFile.exists()) {
            try {
                ...
                try {
                     emailService.sendEmail(new EmailRequest("adm@inovasoft.tech", "Log Semanal - Books-Service", conteudo));
                } catch (Exception e) {
